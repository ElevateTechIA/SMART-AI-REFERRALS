      ...
      <Card className="w-full max-w-md border border-gray-200 bg-white shadow-xl rounded-3xl">
        <CardHeader className="text-center pt-8 pb-4">
          <div className="flex justify-center mb-5">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: 'var(--theme-secondary)' }}>
        ...
        <CardFooter className="flex flex-col gap-3 pb-8 bg-gray-50 rounded-b-3xl">
          <p className="text-sm text-center font-medium text-gray-600">
            {t('auth.noAccount')}{' '}
            <Link href={registerHref} className="hover:opacity-80 font-semibold hover:underline" style={{ color: 'var(--theme-secondary)' }}>
              {t('auth.signUp')}
            </Link>
          </p>
        </CardFooter>
