 ...
 */
export function ReferralPageContent({ offerIdFromRoute }: { offerIdFromRoute?: string }) {
...
// Shared loading fallback so both page wrappers stay identical.
export function ReferralPageFallback() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <Loader2 className="h-8 w-8 animate-spin text-primary" />
    </div>
